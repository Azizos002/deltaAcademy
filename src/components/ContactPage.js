...
export default function ContactPage({
  ...
  return (
    <div
      className={`pt-20 md:pt-24 pb-12 md:pb-16 min-h-screen ${theme.bg} transition-colors duration-500`}
    >
      <div className="max-w-7xl mx-auto px-4">
        <h1
          className={`text-3xl sm:text-4xl md:text-6xl font-bold mb-3 md:mb-4 ${theme.text} text-center`}
        >
          {t.getInTouch}
        </h1>
        <p
          className={`text-base sm:text-lg md:text-xl ${theme.textSecondary} text-center mb-10 md:mb-16`}
        >
        ...
        <div className="grid lg:grid-cols-2 gap-8 md:gap-12 mb-12 md:mb-16">
          <div
            className={`${theme.card} rounded-3xl p-6 sm:p-8 md:p-10 shadow-xl border ${theme.border}`}
          >
            ...
            <form
              ...
              className="space-y-5 md:space-y-6 max-h-[65vh] overflow-y-auto custom-scrollbar pr-1"
            >
              <input
                type="text"
                tabIndex={-1}
          ...
          <div className="space-y-8">
            ...
            >
              ...
              <div className="space-y-5">
                <div
                  className={`flex items-start ${language === "ar" ? "space-x-reverse" : ""} space-x-4`}
                >
                  ...
                  <div>
                    ...
                    <p
                      className={`${theme.textSecondary} text-sm whitespace-pre-line`}
                    >
                      {t.addressText}
                    </p>
                  </div>
            ...
            >
              <h2
                className={`text-2xl md:text-3xl font-bold ${theme.text} mb-4`}
              >
                {t.followUs}
              </h2>
              ...
              <div className="grid grid-cols-2 gap-4">
                {[
                  ...
                  <a
                    ...
                    className={`bg-gradient-to-r ${social.color} text-white p-4 sm:p-5 rounded-2xl text-center transform hover:scale-105 transition-all duration-300 shadow-lg hover:shadow-2xl`}
                  >
        ...
        <div
          className={`${theme.card} rounded-3xl overflow-hidden shadow-2xl border ${theme.border}`}
        >
          ...
          <div className="w-full h-72 sm:h-80 md:h-96 relative">
            <iframe
              ...
              src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3247.888670453451!2d11.05007817557263!3d35.507030972643896!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x1302234de8cba521%3A0xb56302fcf9a34d42!2sCentre%20Delta%20Formation!5e0!3m2!1sfr!2stn!4v1771412887071!5m2!1sfr!2stn"
              width="100%"
              height="100%"
              style={{ border: 0 }}
              allowFullScreen
