...
### Style / UI fixes
- Added new practical and vocational programs (plomberie/chaud-froid, conception mécanique, cuisine, pâtisserie, assistante de vie, hôtellerie, gardiennage, langues) in a structured data model for easier maintenance. (src/constants/data.js, src/components/CoursesPage.js, src/components/LandingPage.js)
